...
import { SyncStatus, SyncItem } from '@offline-pos/sync-contract';
...
/**
 * Section 4: Sync Semantics as Contracts.
 * Following AI-Driven-Implementation-technical-guide.md Section 4.3.
 */
export interface SyncQueueItem extends SyncItem {
   ...
   * Section 4.5.1: stuck IN_FLIGHT recovery.
   */
  inFlightAt?: number;
}
